...
const printMethods = [
    {
        ...
        subtitle: "PRINT ONLY WHEN YOU NEED IT",
        icon: Package,
        features: [
            { text: "No bulk inventory required", good: true },
            { text: "Books produced as ordered", good: true },
            { text: "Global production network", good: true },
            { text: "Lower upfront investment", good: false },
            { text: "Ideal for independent authors", good: true },
        ],
        tag: "Most Flexible"
    },
    {
        title: "Offset Printing",
        subtitle: "BUILT FOR LARGER PRINT RUNS",
        icon: Printer,
        features: [
            { text: "Lower cost per unit", good: true },
            { text: "Enhanced print quality", good: true },
            { text: "Premium finishing options", good: true },
            { text: "No requirement for minimum order", good: false },
            { text: "Ideal for launches, events, & bulk sales", good: true },
        ],
...
const printFinishes = [
    { icon: Layers, title: "PAPER OPTIONS", desc: "Choose from a variety of premium stocks designed to complement your genre, audience, and reading experience." },
    { icon: BookType, title: "BINDING STYLES", desc: "From paperbacks to hardcovers, we offer professional binding options built for durability and presentation." },
    { icon: Droplets, title: "COVER FINISHES", desc: "Matte, gloss, and soft-touch finishes help create the look and feel that best represents your book." },
    { icon: Sparkles, title: "PREMIUM ENHANCEMENTS", desc: "Foil accents, embossing, spot gloss, and specialty effects add an extra layer of distinction." },
];

const processSteps = [
    { step: "01", title: "PRINT PLANNING", desc: "We help select the right trim size, paper, binding, and finish based on your goals and budget.", icon: Scale },
    { step: "02", title: "FILE INSPECTION", desc: "Every file is carefully reviewed to identify potential issues before production begins.", icon: FileCheck },
    { step: "03", title: "PROOF APPROVAL", desc: "You'll receive a physical proof copy to review and approve before moving forward.", icon: Search },
    { step: "04", title: "PRINTING & DELIVERY", desc: "Your books are produced, inspected, packaged, and delivered wherever they're needed.", icon: Truck },
];

const faqs = [
    { q: "Is there a minimum order requirement?", a: "No. We offer both single-copy printing and large-volume print runs." },
    { q: "How long does the printing process take?", a: "Most projects are completed within a few weeks, depending on quantity and specifications." },
    { q: "What file types do you need?", a: "WPrint-ready PDF files are preferred for the best printing results." },
    { q: "Can I purchase author copies?", a: "Yes. You can order discounted copies for events, signings, and personal use." },
    { q: "Which cover finish should I choose?", a: "Matte offers a refined look; gloss provides brighter colors and added shine." },
    { q: "Do you offer hardcover printing?", a: "Yes. We offer both hardcover and paperback options in multiple formats." },
];
            ...
            <section className="relative w-full h-screen flex items-center justify-center bg-[#05070f] overflow-hidden">
                ...
                <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
                    ...
                    <motion.h1 variants={maskReveal} initial="hidden" animate="visible" className="font-black text-white uppercase leading-[0.95] mb-8" style={{ fontSize: "clamp(2.5rem, 6vw, 4rem)" }}>
                        MADE TO BE OPENED. <br /><span className="text-[#e8391d]">KEPT FOR YEARS.</span>
                    </motion.h1>
                    ...
                    <motion.p variants={fadeUp} initial="hidden" animate="visible" className="text-white/60 leading-[1.85] max-w-2xl mx-auto mb-10" style={{ fontSize: "clamp(0.9rem, 1.1vw, 1.05rem)" }}>
                        Nothing compares to the moment your manuscript becomes a real book. The weight in your hands. The turn of the pages. The realization that your words now exist beyond a screen. Let us produce professionally printed books that look brilliant, feel substantial, and leave a lasting impression from the very first touch.
                    </motion.p>
                ...
                <div className="max-w-[1200px] mx-auto px-8 lg:px-16 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    <motion.div variants={staggerContainer} initial="hidden" animate={overviewInView ? "visible" : "hidden"} className="flex flex-col">
                        ...
                        <motion.h2 variants={fadeUp} className="font-black text-black uppercase leading-[1.05] mb-6" style={{ fontSize: "clamp(2rem, 3.8vw, 3.2rem)" }}>
                            PRINTED TO IMPRESS. <br /><span className="text-[#e8391d]">CRAFTED TO LAST.</span>
                        </motion.h2>

                        <motion.p variants={fadeUp} className="text-gray-500 leading-[1.85] mb-5" style={{ fontSize: "0.95rem" }}>
                            Readers form opinions before they read a single chapter. A flimsy cover, weak binding, or poor print quality instantly lowers the perceived value of your book.
                        </motion.p>
                        <motion.p variants={fadeUp} className="text-gray-500 leading-[1.85] mb-8" style={{ fontSize: "0.95rem" }}>
                            That's why we focus on the details that separate professional books from forgettable ones. Premium materials, reliable production, and meticulous quality standards ensure your book arrives looking every bit as important as the story inside.
                        </motion.p>

                        <motion.div variants={staggerContainer} className="flex flex-col gap-4">
                            {["Premium Interior Paper Options", "Hardcover & Paperback Printing", "Physical Proof Copies Available", "Worldwide Printing & Fulfillment"].map((item) => (
                    ...
                    <motion.div initial={{ opacity: 0, scale: 0.9 }} animate={overviewInView ? { opacity: 1, scale: 1 } : {}} transition={{ duration: 0.8, ease: smoothEase }} className="relative hidden lg:block">
                        <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-black/20" style={{ aspectRatio: "4/5" }}>
                            <Image src="/images/Services/DesignMarketing/book-printing/01.jpeg" alt="Book Printing Service" fill className="object-cover" />
                ...
                <div className="max-w-[1200px] mx-auto px-8 lg:px-16 relative z-10">
                    <div className="text-center mb-16 overflow-hidden">
                        ...
                        <motion.h2 variants={maskReveal} initial="hidden" whileInView="visible" viewport={{ once: true }} className="font-black text-white uppercase leading-none" style={{ fontSize: "clamp(2.5rem, 5vw, 4rem)" }}>
                            TWO WAYS TO BRING YOUR <span className="text-[#e8391d]">BOOK TO LIFE </span>
                        </motion.h2>
                    </div>
                ...
                <div className="max-w-[1200px] mx-auto px-8 lg:px-16">
                    <div className="text-center mb-16">
                        ...
                        <motion.h2 variants={maskReveal} initial="hidden" whileInView="visible" viewport={{ once: true }} className="font-black text-black uppercase leading-none" style={{ fontSize: "clamp(2.5rem, 5vw, 4rem)" }}>
                            DETAILS READERS NOTICE <span className="text-[#e8391d]">WITHOUT REALIZING IT</span>
                        </motion.h2>
                        <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.4 }} className="text-gray-400 mt-4 max-w-xl mx-auto text-[15px] leading-relaxed">
                            Readers don’t just see your book. They experience it.
                        </motion.p>
                    </div>
            ...
            <section className="relative w-full bg-[#111] py-32 overflow-hidden">
                <div className="max-w-[1200px] mx-auto px-8 lg:px-16 relative z-10">
                    <div className="text-center mb-20">
                        <motion.h2 variants={maskReveal} initial="hidden" whileInView="visible" viewport={{ once: true }} className="font-black text-white uppercase leading-none" style={{ fontSize: "clamp(2.5rem, 5vw, 4rem)" }}>
                            OUR BOOK PRINTING <span className="text-[#e8391d]">PROCESS</span>
                        </motion.h2>
                    </div>
                ...
                <div className="max-w-[1200px] mx-auto px-8 lg:px-16 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="relative">
                        <div className="rounded-3xl overflow-hidden shadow-2xl" style={{ aspectRatio: "1/1" }}>
                            <Image src="/images/Services/DesignMarketing/book-printing/02.jpg" alt="Book Printing Quality" fill className="object-cover" />
                    ...
                    <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                        ...
                        <motion.h2 variants={fadeUp} className="font-black text-black uppercase leading-[1.05] mb-10" style={{ fontSize: "clamp(2rem, 3.5vw, 3rem)" }}>
                            QUALITY YOU CAN SEE. <br /><span className="text-[#e8391d]">CONFIDENCE YOU CAN FEEL.</span>
                        </motion.h2>

                        <motion.div variants={staggerContainer} className="flex flex-col gap-5">
                            {[
                                "Professional Production Standards — Books are printed using proven methods and materials trusted across the publishing industry.",
                                "Physical Proof Approval — A book in hand is reviewed before committing to a full production run.",
                                "Thorough File Review — Detailed inspections help prevent common printing mistakes before they become expensive problems.",
                                "Flexible Printing Options — Whether you need one copy or thousands, we help you choose the right solution.",
                                "Worldwide Fulfillment — Print closer to readers and reduce shipping times through global production networks."
                            ].map((item) => (
            ...
            <section className="relative w-full bg-[#e8391d] py-28 overflow-hidden">
                ...
                <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="max-w-4xl mx-auto text-center px-8 relative z-10">
                    <h2 className="font-black text-white uppercase leading-tight mb-6" style={{ fontSize: "clamp(2.5rem, 5vw, 4rem)" }}>
                        READY TO SEE YOUR BOOK ON THE SHELF?
                    </h2>
                    <p className="text-white/80 text-lg max-w-xl mx-auto mb-10 leading-relaxed">
                        Let's turn your manuscript into a professionally printed book that readers will proudly hold, display, share, and remember.
                    </p>
